...
# Change Learning Rate Scheduler to Cosine instead of Linear
COSINE_SCHEDULER="--training_arguments.lr_scheduler_type cosine"
...
# Multi-Node DS-Z2, Cosine LR Schedule, Device BSZ = 16 --> Cleanup --> Sleep
deepspeed $DISTRIBUTED_ARGS train.py $CONFIG $INFRA $D_BSZ_16 $COSINE_SCHEDULER $DS_Z2 --run_id beta-dry-run-lr=cosine-dbsz=16
pkill -f "train.py"
sleep 3
