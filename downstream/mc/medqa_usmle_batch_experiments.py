...
for experiment in experiments:
    ...
    seed = experiment["seed"] if "seed" in experiment else 7
    ...
    exp_cmd = (
        ...
        " --validation_file $datadir/dev.json --test_file $datadir/test.json --do_train --do_eval --do_predict"
