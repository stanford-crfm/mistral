...
def main():
    ...
    if args.task_mode == 'data2text':
    ...
    elif args.task_mode in ['cnndm', 'xsum', 'bioleaflets']:
        QUICK_CHECK = False
        if args.task_mode == 'cnndm':
            ...
            prompt_text_lst = read_sum_files(test_path, tokenizer, max_source_length, max_target_length)
    ...
    for prompt_idx, prompt_text in enumerate(tqdm(prompt_text_lst)):
