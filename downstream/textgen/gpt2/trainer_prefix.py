...
class Trainer_Prefix:
    ...
    def train(self, model_path: Optional[str] = None, trial: Union["optuna.Trial", Dict[str, Any]] = None):
        ...
        for epoch in range(epochs_trained, int(np.ceil(num_train_epochs))):
            ...
            epoch_pbar = tqdm(epoch_iterator, desc="Iteration", disable=disable_tqdm, mininterval=30)
    ...
    def prediction_loop(
        ...
        for inputs in tqdm(dataloader, desc=description, disable=disable_tqdm, mininterval=30):
